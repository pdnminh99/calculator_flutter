define(['dart_sdk', 'packages/string_scanner/src/eager_span_scanner', 'packages/boolean_selector/boolean_selector', 'packages/source_span/source_span', 'packages/collection/collection', 'packages/async/async', 'packages/term_glyph/src/generated/ascii_glyph_set', 'packages/matcher/src/core_matchers', 'packages/stream_channel/stream_channel', 'packages/path/path', 'packages/collection/src/canonicalized_map'], function(dart_sdk, packages__string_scanner__src__eager_span_scanner, packages__boolean_selector__boolean_selector, packages__source_span__source_span, packages__collection__collection, packages__async__async, packages__term_glyph__src__generated__ascii_glyph_set, packages__matcher__src__core_matchers, packages__stream_channel__stream_channel, packages__path__path, packages__collection__src__canonicalized_map) {
  ...
  dart.defineLazy(CT, {
    ...
    get C9() {
      return C9 = dart.const({
        ...
        [All_variables]: C10 || CT.C10
      });
    },
    get C8() {
      return C8 = dart.const({
        __proto__: platform_selector.PlatformSelector.prototype,
        [PlatformSelector__span]: null,
        [PlatformSelector__inner]: C9 || CT.C9
      });
    },
    get C11() {
    ...
    get C13() {
      return C13 = dart.const({
        ...
        [Runtime_isHeadless]: false,
        [Runtime_isBlink]: false,
        [Runtime_isJS]: false,
        [Runtime_isBrowser]: false,
        [Runtime_isDartVM]: true,
        [Runtime_parent]: null,
        [Runtime_identifier]: "vm",
        [Runtime_name]: "VM"
      });
    },
    get C14() {
      return C14 = dart.const({
        __proto__: runtime.Runtime.prototype,
        [Runtime_isHeadless]: false,
        [Runtime_isBlink]: true,
        [Runtime_isJS]: true,
        [Runtime_isBrowser]: true,
        [Runtime_isDartVM]: false,
        [Runtime_parent]: null,
        [Runtime_identifier]: "chrome",
        [Runtime_name]: "Chrome"
      });
    },
    get C15() {
      return C15 = dart.const({
        __proto__: runtime.Runtime.prototype,
        [Runtime_isHeadless]: true,
        [Runtime_isBlink]: true,
        [Runtime_isJS]: true,
        [Runtime_isBrowser]: true,
        [Runtime_isDartVM]: false,
        [Runtime_parent]: null,
        [Runtime_identifier]: "phantomjs",
        [Runtime_name]: "PhantomJS"
      });
    },
    get C16() {
    ...
    get C18() {
      return C18 = dart.const({
        ...
        [Runtime_isDartVM]: false,
        [Runtime_parent]: null,
        [Runtime_identifier]: "ie",
        [Runtime_name]: "Internet Explorer"
      });
    },
    get C19() {
  ...
  const OperatingSystem_name = dart.privateName(operating_system, "OperatingSystem.name");
  const OperatingSystem_identifier = dart.privateName(operating_system, "OperatingSystem.identifier");
  let C0;
  let C1;
  let C2;
  let C3;
  ...
  const name$ = OperatingSystem_name;
  const identifier$ = OperatingSystem_identifier;
  ...
  const PlatformSelector__inner = dart.privateName(platform_selector, "PlatformSelector._inner");
  const PlatformSelector__span = dart.privateName(platform_selector, "PlatformSelector._span");
  let C10;
  ...
  const _inner$ = PlatformSelector__inner;
  const _span$ = PlatformSelector__span;
  ...
  const Runtime_name = dart.privateName(runtime, "Runtime.name");
  const Runtime_identifier = dart.privateName(runtime, "Runtime.identifier");
  const Runtime_parent = dart.privateName(runtime, "Runtime.parent");
  const Runtime_isDartVM = dart.privateName(runtime, "Runtime.isDartVM");
  const Runtime_isBrowser = dart.privateName(runtime, "Runtime.isBrowser");
  const Runtime_isJS = dart.privateName(runtime, "Runtime.isJS");
  const Runtime_isBlink = dart.privateName(runtime, "Runtime.isBlink");
  const Runtime_isHeadless = dart.privateName(runtime, "Runtime.isHeadless");
  let C13;
  let C14;
  let C15;
  let C16;
  ...
  const name$0 = Runtime_name;
  const identifier$0 = Runtime_identifier;
  const parent$ = Runtime_parent;
  const isDartVM$ = Runtime_isDartVM;
  const isBrowser$ = Runtime_isBrowser;
  const isJS$ = Runtime_isJS;
  const isBlink$ = Runtime_isBlink;
  const isHeadless$ = Runtime_isHeadless;
  ...
  const Metadata_testOn = dart.privateName(metadata$, "Metadata.testOn");
  const Metadata_timeout = dart.privateName(metadata$, "Metadata.timeout");
  const Metadata_skipReason = dart.privateName(metadata$, "Metadata.skipReason");
  const Metadata_tags = dart.privateName(metadata$, "Metadata.tags");
  const Metadata_onPlatform = dart.privateName(metadata$, "Metadata.onPlatform");
  const Metadata_forTag = dart.privateName(metadata$, "Metadata.forTag");
  ...
  const testOn$ = Metadata_testOn;
  const timeout$0 = Metadata_timeout;
  const skipReason$ = Metadata_skipReason;
  const tags$ = Metadata_tags;
  const onPlatform$ = Metadata_onPlatform;
  const forTag$ = Metadata_forTag;
  ...
  const Skip_reason = dart.privateName(skip$, "Skip.reason");
  ...
  const SuitePlatform_runtime = dart.privateName(suite_platform, "SuitePlatform.runtime");
  const SuitePlatform_os = dart.privateName(suite_platform, "SuitePlatform.os");
  const SuitePlatform_inGoogle = dart.privateName(suite_platform, "SuitePlatform.inGoogle");
  ...
  const runtime$ = SuitePlatform_runtime;
  const os$ = SuitePlatform_os;
  const inGoogle$ = SuitePlatform_inGoogle;
