define(['dart_sdk', 'packages/test_api/src/backend/metadata', 'packages/matcher/src/core_matchers', 'packages/async/async', 'packages/pedantic/pedantic', 'packages/stack_trace/src/chain', 'packages/path/path', 'packages/stream_channel/stream_channel', 'packages/collection/src/canonicalized_map'], function(dart_sdk, packages__test_api__src__backend__metadata, packages__matcher__src__core_matchers, packages__async__async, packages__pedantic__pedantic, packages__stack_trace__src__chain, packages__path__path, packages__stream_channel__stream_channel, packages__collection__src__canonicalized_map) {
  ...
  dart.defineLazy(CT, {
    ...
    get C3() {
      return C3 = dart.const({
        ...
        [MessageType_name]: "print"
      });
    },
    get C4() {
      return C4 = dart.const({
        __proto__: message$.MessageType.prototype,
        [MessageType_name]: "skip"
      });
    },
    get C5() {
    ...
    get C40() {
      return C40 = dart.const({
        __proto__: state.State.prototype,
        [State_result]: C14 || CT.C14,
        [State_status]: C10 || CT.C10
      });
    },
    get C41() {
    ...
    get C43() {
      return C43 = dart.const({
        __proto__: state.State.prototype,
        [State_result]: C13 || CT.C13,
        [State_status]: C11 || CT.C11
      });
    },
    get C44() {
  ...
  const Suite_platform = dart.privateName(suite, "Suite.platform");
  const Suite_path = dart.privateName(suite, "Suite.path");
  const Suite_group = dart.privateName(suite, "Suite.group");
  ...
  const platform$ = Suite_platform;
  const path$ = Suite_path;
  const group$0 = Suite_group;
  ...
  const _Completes__matcher = dart.privateName(future_matchers, "_Completes._matcher");
  ...
  const _matcher$ = _Completes__matcher;
  ...
  const Retry_count = dart.privateName(retry, "Retry.count");
  ...
  const Message_type = dart.privateName(message$, "Message.type");
  const Message_text = dart.privateName(message$, "Message.text");
  ...
  const MessageType_name = dart.privateName(message$, "MessageType.name");
  let C3;
  let C4;
  ...
  const Tags__tags = dart.privateName(tags, "Tags._tags");
  ...
  const Group_name = dart.privateName(group$, "Group.name");
  const Group_metadata = dart.privateName(group$, "Group.metadata");
  const Group_trace = dart.privateName(group$, "Group.trace");
  const Group_entries = dart.privateName(group$, "Group.entries");
  const Group_setUpAll = dart.privateName(group$, "Group.setUpAll");
  const Group_tearDownAll = dart.privateName(group$, "Group.tearDownAll");
  ...
  const name$0 = Group_name;
  const metadata$0 = Group_metadata;
  const trace$0 = Group_trace;
  const entries$ = Group_entries;
  const setUpAll$ = Group_setUpAll;
  const tearDownAll$ = Group_tearDownAll;
  ...
  const _matcher$0 = dart.privateName(throws_matcher, "_matcher");
  ...
  throws_matcher.Throws = class Throws extends async_matcher.AsyncMatcher {
    ...
    [_check](error, trace) {
      ...
      let result = dart.toString(this[_matcher$0].describeMismatch(error, new description$.StringDescription.new(), matchState, false));
      let buffer = new core.StringBuffer.new();
  ...
  const _matcher$1 = Throws__matcher;
  ...
  const TestOn_expression = dart.privateName(test_on, "TestOn.expression");
  ...
  const expression$ = TestOn_expression;
  ...
  const TestFailure_message = dart.privateName(expect, "TestFailure.message");
  ...
  const message$0 = TestFailure_message;
  ...
  const OnPlatform_annotationsByPlatform = dart.privateName(on_platform, "OnPlatform.annotationsByPlatform");
  ...
  const annotationsByPlatform$ = OnPlatform_annotationsByPlatform;
  ...
  const _matcher$2 = dart.privateName(prints_matcher, "_matcher");
  ...
  prints_matcher._Prints = class _Prints extends async_matcher.AsyncMatcher {
    ...
    [_check$](actual) {
      let matchState = new _js_helper.LinkedMap.new();
      if (dart.test(this[_matcher$2].matches(actual, matchState))) return null;
      let result = dart.toString(this[_matcher$2].describeMismatch(actual, new description$.StringDescription.new(), matchState, false));
      let buffer = new core.StringBuffer.new();
      if (actual[$isEmpty]) {
  ...
  const LocalTest_name = dart.privateName(invoker$, "LocalTest.name");
  const LocalTest_metadata = dart.privateName(invoker$, "LocalTest.metadata");
  const LocalTest_trace = dart.privateName(invoker$, "LocalTest.trace");
  const LocalTest_isScaffoldAll = dart.privateName(invoker$, "LocalTest.isScaffoldAll");
  ...
  const name$3 = LocalTest_name;
  const metadata$1 = LocalTest_metadata;
  const trace$1 = LocalTest_trace;
  const isScaffoldAll$ = LocalTest_isScaffoldAll;
  ...
  const LiveTestController_completer = dart.privateName(live_test_controller, "LiveTestController.completer");
  ...
  const completer = LiveTestController_completer;
  ...
  const RemoteException_message = dart.privateName(remote_exception, "RemoteException.message");
  const RemoteException_type = dart.privateName(remote_exception, "RemoteException.type");
  ...
  const message$1 = RemoteException_message;
  const type$0 = RemoteException_type;
