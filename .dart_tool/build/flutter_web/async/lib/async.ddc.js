define(['dart_sdk', 'packages/collection/collection'], function(dart_sdk, packages__collection__collection) {
  ...
  dart.defineLazy(CT, {
    ...
    get C4() {
      return C4 = dart.const({
        ...
        [StreamTransformerWrapper__transformer]: C2 || CT.C2
      });
    },
    get C5() {
      return C5 = dart.const({
        __proto__: stream_group._StreamGroupState.prototype,
        [_StreamGroupState_name]: "dormant"
      });
    },
    get C6() {
      return C6 = dart.const({
        __proto__: stream_group._StreamGroupState.prototype,
        [_StreamGroupState_name]: "listening"
      });
    },
    get C7() {
      return C7 = dart.const({
        __proto__: stream_group._StreamGroupState.prototype,
        [_StreamGroupState_name]: "paused"
      });
    },
    get C8() {
      return C8 = dart.const({
        __proto__: stream_group._StreamGroupState.prototype,
        [_StreamGroupState_name]: "canceled"
      });
    },
    get C9() {
  ...
  const ValueResult_value = dart.privateName(value$, "ValueResult.value");
  value$.ValueResult$ = dart.generic(T => {
    ...
    const value$0 = ValueResult_value;
  ...
  const ErrorResult_error = dart.privateName(error$, "ErrorResult.error");
  const ErrorResult_stackTrace = dart.privateName(error$, "ErrorResult.stackTrace");
  ...
  const error$0 = ErrorResult_error;
  const stackTrace$ = ErrorResult_stackTrace;
  ...
  const _StreamGroupState_name = dart.privateName(stream_group, "_StreamGroupState.name");
  let C5;
  let C6;
  let C7;
  let C8;
  ...
  const name$ = _StreamGroupState_name;
  ...
  cancelable_operation.CancelableOperation$ = dart.generic(T => {
    ...
    class CancelableOperation extends core.Object {
      ...
      valueOrCancellation(cancellationValue) {
        ...
        this[_completer$0][_cancelMemo].future.then(core.Null, dart.fn(_ => {
  ...
  const NullStreamSink_done = dart.privateName(null_stream_sink, "NullStreamSink.done");
  null_stream_sink.NullStreamSink$ = dart.generic(T => {
    ...
    const done$ = NullStreamSink_done;
  ...
  handler_transformer._HandlerSink$ = dart.generic((S, T) => {
    ...
    class _HandlerSink extends core.Object {
      ...
      addStream(stream) {
        StreamOfS()._check(stream);
        return this[_inner$2].addStream(stream.transform(T, new (_StreamHandlerTransformerOfS$T()).new({handleData: SAndEventSinkOfTTovoid()._check(this[_transformer$][_handleData$]), handleError: ObjectAndStackTraceAndEventSinkOfTTovoid()._check(this[_transformer$][_handleError$]), handleDone: C9 || CT.C9})));
      }
      close() {
        if (EventSinkOfTTovoid()._check(this[_transformer$][_handleDone$]) == null) return this[_inner$2].close();
  ...
  const StreamSinkCompleter_sink = dart.privateName(stream_sink_completer, "StreamSinkCompleter.sink");
  stream_sink_completer.StreamSinkCompleter$ = dart.generic(T => {
    ...
    const sink = StreamSinkCompleter_sink;
