define(['dart_sdk'], function(dart_sdk) {
  ...
  const separators = WindowsStyle_separators;
  ...
  const name$ = UrlStyle_name;
  const separator$ = UrlStyle_separator;
  const separators$ = UrlStyle_separators;
  const separatorPattern$ = UrlStyle_separatorPattern;
  const needsSeparatorPattern$ = UrlStyle_needsSeparatorPattern;
  const rootPattern$ = UrlStyle_rootPattern;
  const relativeRootPattern$ = UrlStyle_relativeRootPattern;
  ...
  const separators$0 = ParsedPath_separators;
  ...
  const name$2 = PosixStyle_name;
  const separator$0 = PosixStyle_separator;
  const separators$1 = PosixStyle_separators;
  const separatorPattern$0 = PosixStyle_separatorPattern;
  const needsSeparatorPattern$0 = PosixStyle_needsSeparatorPattern;
  const rootPattern$0 = PosixStyle_rootPattern;
  const relativeRootPattern$0 = PosixStyle_relativeRootPattern;
