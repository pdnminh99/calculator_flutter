...
let modulePaths = {
 ...
 "test/calculation_test": "calculation_test.ddc",
 "test/calculation_test.dart.browser_test": "calculation_test.dart.browser_test.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'calculation_test.dart.browser_test.digests',
...
define("calculation_test.dart.browser_test.dart.bootstrap", ["test/calculation_test.dart.browser_test", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.test__calculation_test$46dart$46browser_test || app.calculation_test$46dart$46browser_test).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "calculation_test.dart.browser_test.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("calculation_test.dart.browser_test.dart.bootstrap", {
    "calculation_test.dart.browser_test.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
