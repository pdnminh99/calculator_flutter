define(['dart_sdk', 'packages/flutter/material', 'packages/myapp/calculator', 'packages/flutter/src/widgets/actions'], function(dart_sdk, packages__flutter__material, packages__myapp__calculator, packages__flutter__src__widgets__actions) {
  'use strict';
  ...
  dart.defineLazy(main, {
    /*main.isDarkTheme*/get isDarkTheme() {
      return true;
    },
    set isDarkTheme(_) {}
  });
