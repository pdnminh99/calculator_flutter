define(['dart_sdk', 'packages/async/async'], function(dart_sdk, packages__async__async) {
  ...
  const VirtualChannel_id = dart.privateName(multi_channel, "VirtualChannel.id");
  const VirtualChannel_stream = dart.privateName(multi_channel, "VirtualChannel.stream");
  const VirtualChannel_sink = dart.privateName(multi_channel, "VirtualChannel.sink");
  multi_channel.VirtualChannel$ = dart.generic(T => {
    ...
    const id$ = VirtualChannel_id;
    const stream$ = VirtualChannel_stream;
    const sink$ = VirtualChannel_sink;
  ...
  const StreamChannelTransformer__streamTransformer = dart.privateName(stream_channel_transformer, "StreamChannelTransformer._streamTransformer");
  const StreamChannelTransformer__sinkTransformer = dart.privateName(stream_channel_transformer, "StreamChannelTransformer._sinkTransformer");
  stream_channel_transformer.StreamChannelTransformer$ = dart.generic((S, T) => {
    ...
    class StreamChannelTransformer extends core.Object {
      get [_streamTransformer$]() {
        return this[_streamTransformer$0];
      }
      set [_streamTransformer$](value) {
        super[_streamTransformer$] = value;
      }
      get [_sinkTransformer$]() {
        return this[_sinkTransformer$0];
      }
    ...
    (StreamChannelTransformer.new = function(_streamTransformer, _sinkTransformer) {
      this[_streamTransformer$0] = _streamTransformer;
      this[_sinkTransformer$0] = _sinkTransformer;
      ;
    ...
    const _streamTransformer$0 = StreamChannelTransformer__streamTransformer;
    const _sinkTransformer$0 = StreamChannelTransformer__sinkTransformer;
  ...
  const CloseGuaranteeChannel__subscription = dart.privateName(close_guarantee_channel, "CloseGuaranteeChannel._subscription");
  close_guarantee_channel.CloseGuaranteeChannel$ = dart.generic(T => {
    ...
    const _subscription$ = CloseGuaranteeChannel__subscription;
