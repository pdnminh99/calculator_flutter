define(['dart_sdk', 'packages/source_span/source_span', 'packages/string_scanner/src/eager_span_scanner'], function(dart_sdk, packages__source_span__source_span, packages__string_scanner__src__eager_span_scanner) {
  ...
  const VariableNode_span = dart.privateName(ast, "VariableNode.span");
  const VariableNode_name = dart.privateName(ast, "VariableNode.name");
  ...
  const span$ = VariableNode_span;
  const name$ = VariableNode_name;
  ...
  const NotNode_span = dart.privateName(ast, "NotNode.span");
  const NotNode_child = dart.privateName(ast, "NotNode.child");
  ...
  const span$0 = NotNode_span;
  const child$ = NotNode_child;
  ...
  const OrNode_left = dart.privateName(ast, "OrNode.left");
  const OrNode_right = dart.privateName(ast, "OrNode.right");
  ...
  const left$ = OrNode_left;
  const right$ = OrNode_right;
  ...
  const AndNode_left = dart.privateName(ast, "AndNode.left");
  const AndNode_right = dart.privateName(ast, "AndNode.right");
  ...
  const left$0 = AndNode_left;
  const right$0 = AndNode_right;
  ...
  const ConditionalNode_condition = dart.privateName(ast, "ConditionalNode.condition");
  const ConditionalNode_whenTrue = dart.privateName(ast, "ConditionalNode.whenTrue");
  const ConditionalNode_whenFalse = dart.privateName(ast, "ConditionalNode.whenFalse");
  ...
  const condition$ = ConditionalNode_condition;
  const whenTrue$ = ConditionalNode_whenTrue;
  const whenFalse$ = ConditionalNode_whenFalse;
  ...
  const Token_type = dart.privateName(token$, "Token.type");
  const Token_span = dart.privateName(token$, "Token.span");
  ...
  const IdentifierToken_type = dart.privateName(token$, "IdentifierToken.type");
  const IdentifierToken_span = dart.privateName(token$, "IdentifierToken.span");
  const IdentifierToken_name = dart.privateName(token$, "IdentifierToken.name");
  ...
  const type = IdentifierToken_type;
  const span$2 = IdentifierToken_span;
  const name$0 = IdentifierToken_name;
  ...
  let C10;
  const None_variables = dart.privateName(none, "None.variables");
  let C11;
  ...
  const variables$ = None_variables;
