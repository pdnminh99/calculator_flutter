define(['dart_sdk', 'packages/flutter/src/foundation/_bitfield_web', 'packages/vector_math/vector_math_64'], function(dart_sdk, packages__flutter__src__foundation___bitfield_web, packages__vector_math__vector_math_64) {
  ...
  dart.defineLazy(CT, {
    ...
    get C8() {
      return C8 = dart.const({
        ...
        [SystemUiOverlayStyle_statusBarIconBrightness]: C9 || CT.C9,
        [SystemUiOverlayStyle_statusBarBrightness]: C10 || CT.C10,
        [SystemUiOverlayStyle_statusBarColor]: null,
        [SystemUiOverlayStyle_systemNavigationBarIconBrightness]: C9 || CT.C9,
        [SystemUiOverlayStyle_systemNavigationBarDividerColor]: null,
        [SystemUiOverlayStyle_systemNavigationBarColor]: C11 || CT.C11
      });
    },
    get C12() {
      return C12 = dart.const({
        __proto__: system_chrome.SystemUiOverlayStyle.prototype,
        [SystemUiOverlayStyle_statusBarIconBrightness]: C10 || CT.C10,
        [SystemUiOverlayStyle_statusBarBrightness]: C9 || CT.C9,
        [SystemUiOverlayStyle_statusBarColor]: null,
        [SystemUiOverlayStyle_systemNavigationBarIconBrightness]: C9 || CT.C9,
        [SystemUiOverlayStyle_systemNavigationBarDividerColor]: null,
        [SystemUiOverlayStyle_systemNavigationBarColor]: C11 || CT.C11
    ...
    get C30() {
      return C30 = dart.const({
        ...
        [TextSelection_affinity]: C14 || CT.C14,
    ...
    get C38() {
      return C38 = dart.const({
        ...
        [OffsetPair_global]: C39 || CT.C39,
        [OffsetPair_local]: C39 || CT.C39
      });
    },
    get C40() {
    ...
    get C41() {
      return C41 = dart.const({
        ...
        [StandardMethodCodec_messageCodec]: C42 || CT.C42
      });
    },
    get C43() {
    ...
    get C45() {
      return C45 = dart.const({
        ...
        [MethodChannel_codec]: C46 || CT.C46,
    ...
    get C49() {
      return C49 = dart.const({
        ...
        [BasicMessageChannel_codec]: C50 || CT.C50,
    ...
    get C51() {
      return C51 = dart.const({
        ...
        [BasicMessageChannel__binaryMessenger]: null,
        [BasicMessageChannel_codec]: C52 || CT.C52,
    ...
    get C55() {
      return C55 = dart.const({
        __proto__: platform_channel.MethodChannel.prototype,
        [MethodChannel__binaryMessenger]: null,
        [MethodChannel_codec]: C41 || CT.C41,
    ...
    get C62() {
      return C62 = dart.const({
        ...
        [Velocity_pixelsPerSecond]: C39 || CT.C39
      });
    },
    get C63() {
    ...
    get C669() {
      return C669 = dart.const({
        ...
        [TextEditingValue_composing]: C13 || CT.C13,
        [TextEditingValue_selection]: C30 || CT.C30,
  ...
  const RawKeyEventDataAndroid_eventSource = dart.privateName(raw_keyboard_android, "RawKeyEventDataAndroid.eventSource");
  const RawKeyEventDataAndroid_vendorId = dart.privateName(raw_keyboard_android, "RawKeyEventDataAndroid.vendorId");
  const RawKeyEventDataAndroid_productId = dart.privateName(raw_keyboard_android, "RawKeyEventDataAndroid.productId");
  ...
  const codePoint$ = RawKeyEventDataAndroid_codePoint;
  const plainCodePoint$ = RawKeyEventDataAndroid_plainCodePoint;
  const keyCode$ = RawKeyEventDataAndroid_keyCode;
  const scanCode$ = RawKeyEventDataAndroid_scanCode;
  const metaState$ = RawKeyEventDataAndroid_metaState;
  const eventSource$ = RawKeyEventDataAndroid_eventSource;
  const vendorId$ = RawKeyEventDataAndroid_vendorId;
  const productId$ = RawKeyEventDataAndroid_productId;
  ...
  const BlacklistingTextInputFormatter_blacklistedPattern = dart.privateName(text_formatter, "BlacklistingTextInputFormatter.blacklistedPattern");
  const BlacklistingTextInputFormatter_replacementString = dart.privateName(text_formatter, "BlacklistingTextInputFormatter.replacementString");
  ...
  const blacklistedPattern$ = BlacklistingTextInputFormatter_blacklistedPattern;
  const replacementString$ = BlacklistingTextInputFormatter_replacementString;
  ...
  const LengthLimitingTextInputFormatter_maxLength = dart.privateName(text_formatter, "LengthLimitingTextInputFormatter.maxLength");
  ...
  const maxLength$ = LengthLimitingTextInputFormatter_maxLength;
  ...
  const WhitelistingTextInputFormatter_whitelistedPattern = dart.privateName(text_formatter, "WhitelistingTextInputFormatter.whitelistedPattern");
  ...
  const whitelistedPattern$ = WhitelistingTextInputFormatter_whitelistedPattern;
  ...
  const codePoint$0 = RawKeyEventDataFuchsia_codePoint;
  ...
  const RawKeyEventDataLinux_unicodeScalarValues = dart.privateName(raw_keyboard_linux, "RawKeyEventDataLinux.unicodeScalarValues");
  ...
  const unicodeScalarValues$ = RawKeyEventDataLinux_unicodeScalarValues;
  const scanCode$0 = RawKeyEventDataLinux_scanCode;
  const keyCode$0 = RawKeyEventDataLinux_keyCode;
  ...
  const _binaryMessenger$0 = EventChannel__binaryMessenger;
  ...
  const event$ = FlutterErrorDetailsForPointerEventDispatcher_event;
  ...
  const keyCode$1 = RawKeyEventDataMacOs_keyCode;
  ...
  const globalPosition$ = TapDownDetails_globalPosition;
  const kind$ = TapDownDetails_kind;
  const localPosition$ = TapDownDetails_localPosition;
  ...
  const globalPosition$0 = TapUpDetails_globalPosition;
  const localPosition$0 = TapUpDetails_localPosition;
  ...
  const ScaleStartDetails_localFocalPoint = dart.privateName(scale, "ScaleStartDetails.localFocalPoint");
  ...
  const localFocalPoint$ = ScaleStartDetails_localFocalPoint;
  ...
  const ScaleUpdateDetails_localFocalPoint = dart.privateName(scale, "ScaleUpdateDetails.localFocalPoint");
  ...
  const localFocalPoint$0 = ScaleUpdateDetails_localFocalPoint;
  ...
  const velocity$ = ScaleEndDetails_velocity;
  ...
  const event$0 = FlutterErrorDetailsForPointerRouter_event;
  ...
  const globalPosition$1 = ForcePressDetails_globalPosition;
  const localPosition$1 = ForcePressDetails_localPosition;
  const pressure$ = ForcePressDetails_pressure;
  ...
  const globalPosition$2 = DragDownDetails_globalPosition;
  const localPosition$2 = DragDownDetails_localPosition;
  ...
  const globalPosition$3 = DragStartDetails_globalPosition;
  const localPosition$3 = DragStartDetails_localPosition;
  ...
  const delta$ = DragUpdateDetails_delta;
  const primaryDelta$ = DragUpdateDetails_primaryDelta;
  const globalPosition$4 = DragUpdateDetails_globalPosition;
  const localPosition$4 = DragUpdateDetails_localPosition;
  ...
  const velocity$0 = DragEndDetails_velocity;
  ...
  const FontLoader_family = dart.privateName(font_loader, "FontLoader.family");
  ...
  const family$ = FontLoader_family;
  ...
  const kind$0 = PointerEvent_kind;
  const device$ = PointerEvent_device;
  const position$ = PointerEvent_position;
  const localPosition$5 = PointerEvent_localPosition;
  const delta$0 = PointerEvent_delta;
  ...
  const pressure$0 = PointerEvent_pressure;
  ...
  const velocity$1 = LongPressEndDetails_velocity;
  ...
  const TextInputConfiguration_inputType = dart.privateName(text_input, "TextInputConfiguration.inputType");
  const TextInputConfiguration_obscureText = dart.privateName(text_input, "TextInputConfiguration.obscureText");
  const TextInputConfiguration_autocorrect = dart.privateName(text_input, "TextInputConfiguration.autocorrect");
  const TextInputConfiguration_actionLabel = dart.privateName(text_input, "TextInputConfiguration.actionLabel");
  const TextInputConfiguration_inputAction = dart.privateName(text_input, "TextInputConfiguration.inputAction");
  const TextInputConfiguration_textCapitalization = dart.privateName(text_input, "TextInputConfiguration.textCapitalization");
  const TextInputConfiguration_keyboardAppearance = dart.privateName(text_input, "TextInputConfiguration.keyboardAppearance");
  ...
  const inputType$ = TextInputConfiguration_inputType;
  const obscureText$ = TextInputConfiguration_obscureText;
  const autocorrect$ = TextInputConfiguration_autocorrect;
  const actionLabel$ = TextInputConfiguration_actionLabel;
  const inputAction$ = TextInputConfiguration_inputAction;
  const textCapitalization$ = TextInputConfiguration_textCapitalization;
  const keyboardAppearance$ = TextInputConfiguration_keyboardAppearance;
  ...
  const RawFloatingCursorPoint_offset = dart.privateName(text_input, "RawFloatingCursorPoint.offset");
  const RawFloatingCursorPoint_state = dart.privateName(text_input, "RawFloatingCursorPoint.state");
  ...
  const offset$0 = RawFloatingCursorPoint_offset;
  const state$ = RawFloatingCursorPoint_state;
  ...
  const TextEditingValue_text = dart.privateName(text_input, "TextEditingValue.text");
  const TextEditingValue_selection = dart.privateName(text_input, "TextEditingValue.selection");
  const TextEditingValue_composing = dart.privateName(text_input, "TextEditingValue.composing");
  let C669;
  ...
  const selection$ = TextEditingValue_selection;
  const composing$ = TextEditingValue_composing;
  ...
  const x$ = LeastSquaresSolver_x;
  const y$ = LeastSquaresSolver_y;
