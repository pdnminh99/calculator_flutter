define(['dart_sdk', 'packages/stack_trace/src/chain'], function(dart_sdk, packages__stack_trace__src__chain) {
  ...
  dart.defineLazy(CT, {
    ...
    get C30() {
      return C30 = dart.const({
        ...
        [_OrderingMatcher__valueInDescription]: true,
        [_OrderingMatcher__comparisonDescription]: "a value equal to",
        [_OrderingMatcher__greaterThanValue]: false,
        [_OrderingMatcher__lessThanValue]: false,
        [_OrderingMatcher__equalValue]: true,
        [_OrderingMatcher__value]: 0
      });
    },
    get C31() {
      return C31 = dart.const({
        __proto__: order_matchers._OrderingMatcher.prototype,
        [_OrderingMatcher__valueInDescription]: true,
        [_OrderingMatcher__comparisonDescription]: "a value not equal to",
        [_OrderingMatcher__greaterThanValue]: true,
        [_OrderingMatcher__lessThanValue]: true,
        [_OrderingMatcher__equalValue]: false,
        [_OrderingMatcher__value]: 0
      });
    },
    get C32() {
      return C32 = dart.const({
        __proto__: order_matchers._OrderingMatcher.prototype,
        [_OrderingMatcher__valueInDescription]: false,
        [_OrderingMatcher__comparisonDescription]: "a positive value",
        [_OrderingMatcher__greaterThanValue]: true,
        [_OrderingMatcher__lessThanValue]: false,
        [_OrderingMatcher__equalValue]: false,
        [_OrderingMatcher__value]: 0
    ...
    get C33() {
      return C33 = dart.const({
        __proto__: order_matchers._OrderingMatcher.prototype,
        [_OrderingMatcher__valueInDescription]: false,
        [_OrderingMatcher__comparisonDescription]: "a non-positive value",
        [_OrderingMatcher__greaterThanValue]: false,
        [_OrderingMatcher__lessThanValue]: true,
        [_OrderingMatcher__equalValue]: true,
        [_OrderingMatcher__value]: 0
    ...
    get C34() {
      return C34 = dart.const({
        __proto__: order_matchers._OrderingMatcher.prototype,
        [_OrderingMatcher__valueInDescription]: false,
        [_OrderingMatcher__comparisonDescription]: "a negative value",
        [_OrderingMatcher__greaterThanValue]: false,
        [_OrderingMatcher__lessThanValue]: true,
        [_OrderingMatcher__equalValue]: false,
        [_OrderingMatcher__value]: 0
    ...
    get C35() {
      return C35 = dart.const({
        __proto__: order_matchers._OrderingMatcher.prototype,
        [_OrderingMatcher__valueInDescription]: false,
        [_OrderingMatcher__comparisonDescription]: "a non-negative value",
        [_OrderingMatcher__greaterThanValue]: true,
        [_OrderingMatcher__lessThanValue]: false,
        [_OrderingMatcher__equalValue]: true,
        [_OrderingMatcher__value]: 0
  ...
  const _ContainsValue__value = dart.privateName(map_matchers, "_ContainsValue._value");
  ...
  const _value$ = _ContainsValue__value;
  ...
  const _ContainsMapping__key = dart.privateName(map_matchers, "_ContainsMapping._key");
  const _ContainsMapping__valueMatcher = dart.privateName(map_matchers, "_ContainsMapping._valueMatcher");
  ...
  const _key$ = _ContainsMapping__key;
  const _valueMatcher$ = _ContainsMapping__valueMatcher;
  ...
  const _IsSameAs__expected = dart.privateName(core_matchers, "_IsSameAs._expected");
  ...
  const _expected$ = _IsSameAs__expected;
  ...
  const _HasLength__matcher = dart.privateName(core_matchers, "_HasLength._matcher");
  ...
  const _matcher$0 = _HasLength__matcher;
  ...
  const _Contains__expected = dart.privateName(core_matchers, "_Contains._expected");
  ...
  const _expected$0 = _Contains__expected;
  ...
  const _In__source = dart.privateName(core_matchers, "_In._source");
  const _In__containsFunction = dart.privateName(core_matchers, "_In._containsFunction");
  core_matchers._In$ = dart.generic(T => {
    ...
    const _source$ = _In__source;
    const _containsFunction$ = _In__containsFunction;
  ...
  const _value$0 = dart.privateName(string_matchers, "_value");
  ...
  const _StringStartsWith__prefix = dart.privateName(string_matchers, "_StringStartsWith._prefix");
  ...
  const _prefix$ = _StringStartsWith__prefix;
  ...
  const _StringEndsWith__suffix = dart.privateName(string_matchers, "_StringEndsWith._suffix");
  ...
  const _suffix$ = _StringEndsWith__suffix;
  ...
  const _StringContainsInOrder__substrings = dart.privateName(string_matchers, "_StringContainsInOrder._substrings");
  ...
  const _substrings$ = _StringContainsInOrder__substrings;
  ...
  const _value$1 = dart.privateName(equals_matcher, "_value");
  equals_matcher._StringEqualsMatcher = class _StringEqualsMatcher extends feature_matcher.FeatureMatcher$(core.String) {
    typedMatches(item, matchState) {
      core.String._check(item);
      return this[_value$1] == item;
    }
    describe(description) {
      return description.addDescriptionOf(this[_value$1]);
    }
    describeTypedMismatch(item, mismatchDescription, matchState, verbose) {
      core.String._check(item);
      ...
      let escapedValue = util.escape(this[_value$1]);
  ...
  dart.setFieldSignature(equals_matcher._StringEqualsMatcher, () => ({
    ...
    [_value$1]: dart.finalFieldType(core.String)
  }));
  const _expected$1 = dart.privateName(equals_matcher, "_expected");
  ...
  equals_matcher._DeepMatcher = class _DeepMatcher extends interfaces.Matcher {
    ...
    matches(item, matchState) {
      return this[_match](this[_expected$1], item, matchState) == null;
    }
    describe(description) {
      return description.addDescriptionOf(this[_expected$1]);
    }
    describeMismatch(item, mismatchDescription, matchState, verbose) {
      let t5;
  ...
  dart.setFieldSignature(equals_matcher._DeepMatcher, () => ({
    ...
    [_expected$1]: dart.finalFieldType(core.Object),
  ...
  const _matcher$1 = dart.privateName(iterable_matchers, "_matcher");
  ...
  iterable_matchers._EveryElement = class _EveryElement extends iterable_matchers._IterableMatcher {
    ...
    describeTypedMismatch(item, mismatchDescription, matchState, verbose) {
      ...
      if (matchState[$_get]("index") != null) {
        ...
        this[_matcher$1].describeMismatch(element, subDescription, core.Map.as(matchState[$_get]("state")), verbose);
  ...
  iterable_matchers._AnyElement = class _AnyElement extends iterable_matchers._IterableMatcher {
    typedMatches(item, matchState) {
      core.Iterable._check(item);
      return item[$any](dart.fn(e => this[_matcher$1].matches(e, matchState), dynamicTobool()));
    }
    describe(description) {
  ...
  iterable_matchers._OrderedEquals = class _OrderedEquals extends iterable_matchers._IterableMatcher {
    typedMatches(item, matchState) {
      core.Iterable._check(item);
      return this[_matcher$1].matches(item, matchState);
    }
    describe(description) {
  ...
  (iterable_matchers._OrderedEquals.new = function(_expected) {
    ...
    this[_matcher$1] = equals_matcher.equals(_expected, 1);
  ...
  (iterable_matchers._UnorderedMatches.new = function(expected, opts) {
    ...
    this[_expected$2] = expected[$map](interfaces.Matcher, C28 || CT.C28)[$toList]();
  ...
  iterable_matchers._ContainsAllInOrder = class _ContainsAllInOrder extends iterable_matchers._IterableMatcher {
    [_test](item, matchState) {
      let matchers = this[_expected$2][$map](interfaces.Matcher, C28 || CT.C28)[$toList]();
      let matcherIndex = 0;
  ...
  const _value$2 = dart.privateName(numeric_matchers, "_value");
  const _delta = dart.privateName(numeric_matchers, "_delta");
  const _IsCloseTo__value = dart.privateName(numeric_matchers, "_IsCloseTo._value");
  const _IsCloseTo__delta = dart.privateName(numeric_matchers, "_IsCloseTo._delta");
  numeric_matchers._IsCloseTo = class _IsCloseTo extends feature_matcher.FeatureMatcher$(core.num) {
    ...
    typedMatches(item, matchState) {
      core.num._check(item);
      let diff = dart.notNull(item) - dart.notNull(this[_value$2]);
      if (diff < 0) diff = -diff;
  ...
  const _value$3 = _IsCloseTo__value;
  const _delta$ = _IsCloseTo__delta;
  ...
  const _InRange__low = dart.privateName(numeric_matchers, "_InRange._low");
  const _InRange__high = dart.privateName(numeric_matchers, "_InRange._high");
  const _InRange__lowMatchValue = dart.privateName(numeric_matchers, "_InRange._lowMatchValue");
  const _InRange__highMatchValue = dart.privateName(numeric_matchers, "_InRange._highMatchValue");
  ...
  const _low$ = _InRange__low;
  const _high$ = _InRange__high;
  const _lowMatchValue$ = _InRange__lowMatchValue;
  const _highMatchValue$ = _InRange__highMatchValue;
  ...
  const _value$4 = dart.privateName(order_matchers, "_value");
  ...
  const _OrderingMatcher__value = dart.privateName(order_matchers, "_OrderingMatcher._value");
  const _OrderingMatcher__equalValue = dart.privateName(order_matchers, "_OrderingMatcher._equalValue");
  const _OrderingMatcher__lessThanValue = dart.privateName(order_matchers, "_OrderingMatcher._lessThanValue");
  const _OrderingMatcher__greaterThanValue = dart.privateName(order_matchers, "_OrderingMatcher._greaterThanValue");
  const _OrderingMatcher__comparisonDescription = dart.privateName(order_matchers, "_OrderingMatcher._comparisonDescription");
  const _OrderingMatcher__valueInDescription = dart.privateName(order_matchers, "_OrderingMatcher._valueInDescription");
  order_matchers._OrderingMatcher = class _OrderingMatcher extends interfaces.Matcher {
    ...
    matches(item, matchState) {
      if (dart.equals(item, this[_value$4])) {
        return this[_equalValue];
      } else if (dart.dtest(dart.dsend(item, '<', [this[_value$4]]))) {
        return this[_lessThanValue];
      } else if (dart.dtest(dart.dsend(item, '>', [this[_value$4]]))) {
        return this[_greaterThanValue];
      } else {
    ...
    describe(description) {
      if (dart.test(this[_valueInDescription])) {
        return description.add(this[_comparisonDescription]).add(" ").addDescriptionOf(this[_value$4]);
      } else {
  ...
  const _value$5 = _OrderingMatcher__value;
  const _equalValue$ = _OrderingMatcher__equalValue;
  const _lessThanValue$ = _OrderingMatcher__lessThanValue;
  const _greaterThanValue$ = _OrderingMatcher__greaterThanValue;
  const _comparisonDescription$ = _OrderingMatcher__comparisonDescription;
  const _valueInDescription$ = _OrderingMatcher__valueInDescription;
  ...
  const _matcher$2 = dart.privateName(operator_matchers, "_matcher");
  const _IsNot__matcher = dart.privateName(operator_matchers, "_IsNot._matcher");
  operator_matchers._IsNot = class _IsNot extends interfaces.Matcher {
    get [_matcher$2]() {
      return this[_matcher$3];
    }
  ...
  const _matcher$3 = _IsNot__matcher;
  ...
  const _AllOf__matchers = dart.privateName(operator_matchers, "_AllOf._matchers");
  ...
  const _matchers$ = _AllOf__matchers;
  ...
  const _AnyOf__matchers = dart.privateName(operator_matchers, "_AnyOf._matchers");
  ...
  const _matchers$0 = _AnyOf__matchers;
